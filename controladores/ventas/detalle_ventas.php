...
<body>
    <div class="container">
                        ...
                        <?php if (count($ventas) > 0) : ?>
                            <?php foreach ($ventas as $key => $venta) : ?>
                                <tr>
                                    ...
                                    <td><?= $venta['TOTAL'] ?></td>
                                    <td><a class="btn btn-info w-100" href="/Practica_no.9/vistas/ventas/factura.php?venta_id=<?php echo $venta['DETALLE_ID'] ?>">VER DETALLE</a></td>
                                </tr>
                            <?php endforeach ?>
                        <?php else : ?>
                            <tr>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                <a href="/Practica_no.9/vistas/ventas/buscar.php" class="btn btn-info w-100">Volver al formulario</a>
            </div>
        </div>
    </div>
</body>
